...
export const BooksCollection: BookMetadata[] = [
  {
    ...
    genres: [Genres['Фантастика'], Genres['Детектив']],
    contents: [],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    genres: [Genres['Фантастика'], Genres['Кіберпанк'], Genres['Пост-апокаліпсис']],
    contents: [],
  },
  {
    id: 9,
    ...
    genres: [Genres['Комп\'ютерні ігри'], Genres['Артбук']],
    contents: [],
  },
  {
    id: 10,
    ...
    genres: [Genres['Культура та мистецтво'], Genres['Татуювання'], Genres['Артбук']],
    contents: [],
  },
  {
    id: 11,
    ...
    genres: [Genres['Графічні новели'], Genres['Фантастика'], Genres['Антиутопія'], Genres['Артбук']],
    contents: [],
  },
  {
    id: 12,
    ...
    genres: [Genres['Фантастика'], Genres['Антологія']],
    contents: [
